        ...
        <nav class='navbar navbar-expand-lg bg-none navbar-dark py-3'>
            ...
            <div class='collapse navbar-collapse justify-content-between' id='navbarCollapse'>
                <div class='navbar-nav  p-4 mb-5'>
                    ...
                    <a href='allUser.php' class='nav-item nav-link active'>Users</a>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
                            <h1 class="text-white mb-4 mt-5">Edit User</h1>
                                        ...
                                        <div class='form-group row my-4'>
                                            ...
                                            <div class='col-sm-10'>
                                                <input type='password' class='form-control' id='inputEmail3'
                                                    name='password' value=<?php echo $data[0]['password']; ?>>
                                            </div>
                                        </div>
                                        <div class='form-group row my-4'>
                                            <label for='inputEmail3' class='col-sm-2 col-form-label'>Room Number</label>
                                            <div class='col-sm-10'>
                                                <input type='text' class='form-control' id='inputEmail3' name='roomId'
                                                    value=<?php echo $roomData['roomName']; ?>>
                                            </div>
                                        </div>
                                        <div class='form-group row my-4'>
                                            <label for='inputEmail3' class='col-sm-2 col-form-label'>EXT</label>
                                            <div class='col-sm-10'>
                                                <input type='text' class='form-control' id='inputEmail3' name='ext'
                                                    value=<?php echo $data[0]['ext']; ?>>
                                            </div>
                                        </div>
