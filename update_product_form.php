<?php
echo "<link rel='stylesheet' href='users_table.css'>";
                    ...
                    <div class="col-lg-12">
                        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
                         <div class="fs-4 mb-4">
                            ...
                            <form class="mb-5" method="post" action="update_product.php?id=<?php echo  $_GET['id'] ; ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col  fs-4">
                                        <select class="custom-select bg-transparent border-primary px-4"
                                            ...
                                            <?php $db = new Database('cafteriPHPproject', 'root', '123456', '127.0.0.1', '3306');
                                            if ($db) {
