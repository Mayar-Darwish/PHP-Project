                            ...
                            <form class="mb-5" method="post" action="SubmitUser.php" enctype="multipart/form-data">
                                <div class="form-group row ">
                                    ...
                                    <div class="col-lg-8 col">
                                        <input type="text"
                                            class="form-control text-light bg-transparent border-primary p-4"
                                            name="name" id="UserName"
                                            value="<?php if (isset($oldDataa['name'])) {
                                                echo $oldDataa['name'];
                                            } ?>"
                                            required />
                                        <span style="color:red;">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-lg-8 col">
                                        <input type="email"
                                            class="form-control text-light bg-transparent border-primary p-4"
                                            name="email" id="email"
                                            value="<?php if (isset($oldDataa['email'])) {
                                                echo $oldDataa['email'];
                                            } ?>"
                                            required />
                                        <span style="color:red;">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-lg-8 col">
                                        <input type="password"
                                            ...
                                            value="<?php if (isset($oldDataa['password'])) {
                                                echo $oldDataa['password'];
                                            } ?>"
                                            required />
                                        <span style="color:red;">
                                ...
                                <div class="form-group row ">
                                    <div class="col-lg-2 col  fs-4">
                                        <label for="confirmPassword" class="text-white col-form-label">Confirm
                                            Password</label>
                                    </div>
                                    <div class="col-lg-8 col">
                                        <input type="password"
                                            ...
                                            value="<?php if (isset($oldDataa['confirmPass'])) {
                                                echo $oldDataa['confirmPass'];
                                            } ?>"
                                            required />
                                        <span style="color:red;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col">
                                        <select class="form-select bg-transparent text-light border-primary"
                                            name="roomNo" aria-label="Default select example" required>
                                            <option value="" class="bg-transparent text-dark border-primary" disabled
                                                selected hidden>Select Room NO.</option>
                                            <?php
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-lg-8 col">
                                        <input type="text"
                                            class="form-control text-light bg-transparent border-primary p-4" name="ext"
                                            id="ext"
                                            value="<?php if (isset($oldDataa['ext'])) {
                                                echo $oldDataa['ext'];
                                            } ?>"
                                            required />
                                        <span style="color:red;">
                                ...
                                <div class="form-group row ">
                                    <div class="col-lg-2 col  fs-4">
                                        <label for="profilePic" class="text-white col-form-label">Profile
                                            Picture</label>
                                    </div>
                                    <div class="col-lg-8 col">
                                        <input class="form-control text-light bg-transparent border-primary" type="file"
                                            id="profilePic" hidden name="profilePic"
                                            value="<?php if (isset($oldDataa['profilePic'])) {
                                                echo $oldDataa['profilePic'];
                                            } ?>">
                                        <!--span will show that the data choosed successfully or field required-->
                                        <button class="btn btn-primary  font-weight-bold py-2" type="button"><label
                                                for="profilePic" class="text-dark col-form-label">Choose
                                        ...
                                        <span style="color: white">
                                            <?php if (isset($oldDataa['profilePic'])) {
                                                echo "Enter Profile Picture again";
                                            } ?>
                                        </span>
